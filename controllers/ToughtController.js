...
module.exports = class ToughtController{
    static async showToughts(req,res){
        ...
        const toughts = toughtsData.map((toughts)=> toughts.get({plain:true}))
    ...
    static async createToughtSave(req,res){
       ...
       try {
            ...
            console.log("Aconteceu um error ao criar um pensamento: " + error);
       }
    ...
    static async removeTought(req,res){
        ...
        try {
            ...
            console.log(("Erro ao excluir um Pensamento:"+ error));
        }
    }
